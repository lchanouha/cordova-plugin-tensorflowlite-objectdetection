function TensorFlowLite(modelId, model) {
...
TensorFlowLite.prototype.load = function(successCallback, errorCallback) {
    var promise;
...
TensorFlowLite.prototype.checkCached = function(successCallback, errorCallback) {
    var promise;
    if (window.Promise && !successCallback) {
        promise = new Promise(function(resolve, reject) {
            successCallback = resolve;
...
TensorFlowLite.prototype.classify = function(image, successCallback, errorCallback) {
    var promise;
    if (window.Promise && !successCallback) {
        promise = new Promise(function(resolve, reject) {
            successCallback = resolve;
...
function loadModel(modelId, callback, errorCallback, progressCallback) {
    ...
    function initClassifier() {
        ...
        cordova.exec(function() {
            model.loaded = true;
            callback(model);
        }, errorCallback, "TensorFlowLite", "loadModel", [
            model.id,
            modelPath,
            labelPath,
            model.input_size,
